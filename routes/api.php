...
use App\Http\Controllers\Api\LawContactController;
use App\Http\Controllers\Api\LawNotificationController;
use App\Http\Controllers\Api\LawSubscriptionController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(EnsureCompanyContext::class)->group(function () {
        ...
        Route::delete('/law/subscription/change', [LawSubscriptionController::class, 'cancelPending']);
        Route::get('/law/notifications', [LawNotificationController::class, 'index']);
        Route::patch('/law/notifications/{notification}/read', [LawNotificationController::class, 'read']);
        Route::get('/law/contacts', [LawContactController::class, 'index']);
        Route::post('/law/contacts', [LawContactController::class, 'store']);
        Route::patch('/law/contacts/{contactId}', [LawContactController::class, 'update']);
        Route::delete('/law/contacts/{contactId}', [LawContactController::class, 'destroy']);
