  ...
  <div id="profile-sections" class="law-profile-sections" hidden>
    <section class="law-profile-card" aria-labelledby="personal-title">
      ...
      <form id="personal-form" class="law-profile-form" novalidate>
        <label class="law-profile-field"><span>Nome completo</span><input class="fs-form-control" id="profile-name" name="name" autocomplete="name" maxlength="255" required /></label>
        <label class="law-profile-field"><span>Telefone <small>opcional</small></span><input class="fs-form-control" id="profile-phone" name="phone" type="tel" autocomplete="tel-national" inputmode="tel" maxlength="16" placeholder="(00) 00000-0000" aria-describedby="phone-help" /><small id="phone-help">Número brasileiro com DDD. Ainda não verificado; usado apenas como contato.</small></label>
        <label class="law-profile-field"><span>CPF</span><input class="fs-form-control" id="profile-cpf" type="text" readonly aria-describedby="cpf-help" /><small id="cpf-help">Por segurança, a alteração do CPF é feita pelo suporte Fokus Cloud.</small></label>
    ...
    <section class="law-profile-card" aria-labelledby="email-title">
      ...
      <form id="email-form" class="law-profile-form" novalidate>
        <label class="law-profile-field"><span>Novo endereço de e-mail</span><input class="fs-form-control" name="email" type="email" autocomplete="email" maxlength="255" required /></label>
        <label class="law-profile-field"><span>Senha atual</span><input class="fs-form-control" name="current_password" type="password" autocomplete="current-password" required /></label>
    ...
    <section class="law-profile-card" aria-labelledby="security-title">
      ...
      <form id="security-form" class="law-profile-form" novalidate>
        ...
        <div class="law-profile-password-row">
          <label class="law-profile-field"><span>Nova senha</span><input class="fs-form-control" name="password" type="password" autocomplete="new-password" minlength="12" required aria-describedby="password-help" /></label>
          <label class="law-profile-field"><span>Confirme a nova senha</span><input class="fs-form-control" name="password_confirmation" type="password" autocomplete="new-password" minlength="12" required /></label>
        </div>
