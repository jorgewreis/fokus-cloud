 ...
 */
(() => {
    const ASSET_VERSION = "20260922-backoffice-contract-v2";

    const pages = {
        "platform-dashboard-final": { route: "painel", fragment: "platform-dashboard-final" },
        companies: { route: "empresas", fragment: "companies" },
        "subscription-plans": { route: "planos", fragment: "subscription-plans", role: "superadministrador" },
        products: { route: "produtos", fragment: "products", role: "superadministrador" },
